<?php
    ...
    if(isset($_SERVER["REQUEST_METHOD"]) && $_SERVER["REQUEST_METHOD"] == "POST")
    {
        if ($_POST["submit"] == "Edit")
        {
            ...
            {
                echo '<script>alert("Description contains maximum 5000 characters")</script>';
            }
            ...
            {
                $newsql = "UPDATE products SET name = '$name', description = '$description', price = '$price', image = '$img' WHERE id = '$id'";
...
<body>
    <div class="container bg-light" style="width: 600px">
        <div class="row">
            <h2 class="text-center fw-bold mt-2">Edit</h2>
        </div>
